...
```
npm create cloudflare@latest -- --template=cloudflare/templates/twilight-heart-28fb
```

A live public deployment of this template is available at [https://twilight-heart-28fb.templates.workers.dev](https://twilight-heart-28fb.templates.workers.dev)
